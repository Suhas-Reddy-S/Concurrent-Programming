...
static void insert(uint32_t* in_arr, map<uint32_t, uint32_t>* buckets, const uint32_t* mins, size_t k, queue<bucket_sort_params_t>& tasks) {
	while (true) {
...
void bucket_sort_pthread(uint32_t* in_arr, size_t len, size_t k, size_t num_threads) {
