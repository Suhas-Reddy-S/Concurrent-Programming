...
# List of input files
input_files=("2048.txt")

# List of container types
container_types=("sgl_Q" "ms_Q" "fc_sql_Q" "fc_ms_Q" "sgl_stk" "t_stk" "e_sgl_stk" "e_t_stk" "fc_sgl_stk" "fc_t_stk")
# container_types=("sgl_Q" "ms_Q" "fc_sql_Q" "fc_ms_Q")
# container_types=("sgl_stk" "fc_sgl_stk" "e_sgl_stk" "t_stk" "e_t_stk" "fc_t_stk")
